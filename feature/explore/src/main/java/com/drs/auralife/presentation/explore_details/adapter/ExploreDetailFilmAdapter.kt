package com.drs.auralife.presentation.explore_details.adapter
...
class ExploreDetailFilmAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_film_vertical, parent, false)
